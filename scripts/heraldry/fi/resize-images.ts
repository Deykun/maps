...
images.forEach(({ type, imageSrc, imageFile }, index) => {
  ...
  sharp(imageSrc).trim(trimOptions).resize(null, 200).toFile(`./public/images/heraldry/fi/web-${type}/${imageName}-x2.webp`);
  sharp(imageSrc).trim(trimOptions).resize(null, 300).toFile(`./public/images/heraldry/fi/web-${type}/${imageName}-x3.webp`);
  sharp(imageSrc).trim(trimOptions).resize(null, 400).toFile(`./public/images/heraldry/fi/web-${type}/${imageName}-x4.webp`);
