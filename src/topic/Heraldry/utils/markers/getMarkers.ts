...
export const getMarkers = ({
  ...
  if (!animals.includes('bird') && animals.some((active) => ['crane', 'cormorant', 'duck', 'eagle', 'falcon', 'capercaillie', 'goose', 'gull', 'grouse', 'hawk', 'heron', 'owl', 'parrot', 'peacock', 'pelican', 'pigeon', 'phoenix', 'stork', 'raven', 'rooster', 'swan', 'vulture'].includes(active))) {
    animals.push('bird');
  }
