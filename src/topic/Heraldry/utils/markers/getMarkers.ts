...
export const getMarkers = ({
  ...
  if (!animals.includes('bird') && animals.some((active) => ['crane', 'duck', 'eagle', 'falcon', 'goose', 'gull', 'grouse', 'hawk', 'heron', 'owl', 'peacock', 'pelican', 'phoenix', 'stork', 'raven', 'rooster', 'swan', 'vulture'].includes(active))) {
    animals.push('bird');
  }
