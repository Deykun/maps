export const PATHS_DATA: {
  ...
  {
    type: "heraldryCountry",
    pathNameLink: "heraldry.nl.mapTitle",
    path: "nederlandse-heraldiek",
    title:
  ...
  },
  {
    ...
    path: "heraldyka",
    title:
      "Herby polskich miast, powiatów i gmin - Heraldyka, mapa | Polska | Mapy heraldyczne",
    social: `  
...
export const HERALDRY_COUNTRIES = PATHS_DATA.filter(
  ({ type }) => type === "heraldryCountry"
);
